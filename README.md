...
This project is available under the following conditions (Non-Commercial & Attribution):
- **Attribution**: You must clearly attribute the original author (Shin Mingyu) when using this software.
- **Non-Commercial**: Sale or use for commercial purposes is strictly prohibited.
